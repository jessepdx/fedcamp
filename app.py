...
def robots():
    ...
    lines = [
        ...
        "",
        "# Content signals (see contentsignals.org). All three granted: this is",
        "# public federal data, the whole database is a free download, and the",
        "# site exists to get campground facts in front of people. Training",
        "# included -- an assistant that knows this data is the site working.",
